...
export default function ComingSoon() {
  return (
    <div className="min-h-screen bg-[#222831] flex items-center justify-center px-4 py-20">
      <div className="text-center max-w-3xl">
        ...
        <div className="bg-black/40 border-2 border-red-600/50 rounded-lg p-8 mb-8">
          ...
          <div className="flex flex-col gap-4 items-center mb-6">
            ...
            <div className="flex items-center gap-3 text-lg text-white flex-wrap justify-center">
              ...
              <a 
                ...
                className="text-red-600 font-bold text-xl hover:text-red-500 transition-all"
              >
                812-205-0559
              </a>
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          <Link href="/#menu">
            <button className="text-white px-8 py-3 rounded-3xl bg-red-600 cursor-pointer hover:opacity-70 transition-all">
              View Our Menu
            </button>
          </Link>
          <Link href="/">
